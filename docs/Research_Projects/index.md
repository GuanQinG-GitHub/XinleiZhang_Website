...
<div markdown="1" style="background-color: #f0f7ff; padding: 20px; border-radius: 8px; margin: 20px 0;">
## ZSG-MPPI: Robust Model-Predictive Path-Integral Method for Disturbance Handling
<figure markdown>
  ![](ZSG-MPPI/BlockDiagram.png){ width="500" }
...
<figure markdown>
  ![](Ambiguity/EMsystem.png){ width="500" }
</figure>  
...
<figure markdown>
  ![](Multiple_magnet_tracking/multiple_magnet_tracking.gif){ width="1000" }
</figure>
