...
<div markdown="1" style="background-color: #fff5f0; padding: 20px; border-radius: 8px; margin: 20px 0;">
...
<div markdown="1" style="background-color: #f0f9ff; padding: 20px; border-radius: 8px; margin: 20px 0;">
...
<figure markdown>
  ![](NCSU/MAE589-2025Fall/BlockDiagram.png){ width="1000" }
...
<div markdown="1" style="background-color: #fef3ff; padding: 20px; border-radius: 8px; margin: 20px 0;">
...
<figure markdown>
  ![](NCSU/CSC791-2025Spring/Q-Learning/Figure5_training_trajectory.png){ width="1000" }
...
<div style="display: flex; gap: 10px; align-items: flex-start;">
<figure style="flex: 1;">
  <img src="NCSU/CSC791-2025Spring/reference.png" style="width: 100%;">
  <figcaption>Reference Trajectory - N Shape</figcaption>
</figure>

<figure style="flex: 1;">
  <img src="NCSU/CSC791-2025Spring/Result_MPC_trajectory.png" style="width: 100%;">
...
<div markdown="1" style="background-color: #f0fff4; padding: 20px; border-radius: 8px; margin: 20px 0;">
...
<div markdown="1" style="background-color: #fffbf0; padding: 20px; border-radius: 8px; margin: 20px 0;">
...
<div markdown="1" style="background-color: #f5f0ff; padding: 20px; border-radius: 8px; margin: 20px 0;">
